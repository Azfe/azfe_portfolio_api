...
Dependency overrides replace real use cases and repositories with mock
implementations, allowing tests to run without MongoDB while still exercising
the full DI-connected router code path.
"""
...
# =====================================================================
# CV MOCK (with all fields for CVCompleteResponse schema)
# =====================================================================


@dataclass
class _MockCompleteCVResponse:
    """Mock CV response with all fields that CVCompleteResponse schema expects."""
...
async def _apply_dependency_overrides():
    ...
    This fixture is autouse so it applies to every test in tests/integration/api/.
    """
    ...
    # -- CV --
    cv_response = _MockCompleteCVResponse(
